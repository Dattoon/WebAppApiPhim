...
{
    /// <inheritdoc />
    public partial class Migrationf1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Actors = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ...
                    RawData = table.Column<string>(type: "ntext", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_CachedMovies_Slug", x => x.Slug);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MovieSlug = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    EpisodeSlug = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EpisodeName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    EpisodeSlug = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    EmbedUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    M3u8Url = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CachedMovies_Country",
                table: "CachedMovies",
                column: "Country");

            migrationBuilder.CreateIndex(
                name: "IX_CachedMovies_Genres",
                table: "CachedMovies",
                column: "Genres");

            migrationBuilder.CreateIndex(
                name: "IX_CachedMovies_Name",
                table: "CachedMovies",
                column: "Name");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CachedMovies_Type",
                table: "CachedMovies",
                column: "Type");

            migrationBuilder.CreateIndex(
                name: "IX_CachedMovies_Year",
                table: "CachedMovies",
                column: "Year");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieStatistics_AverageRating",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieStatistics_ViewCount",
                table: "MovieStatistics",
                column: "ViewCount");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieTypes_Slug",
                table: "MovieTypes",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserComments_CreatedAt",
                table: "UserComments",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRatings_UserId_MovieSlug",
                table: "UserRatings",
                columns: new[] { "UserId", "MovieSlug" },
                unique: true);
        }
